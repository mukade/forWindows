...
public class _8_TicTacToeServer extends JFrame
    implements _8_TicTacToeConstants {
  public static void main(String[] args) {
    _8_TicTacToeServer frame = new _8_TicTacToeServer();
  }

  public _8_TicTacToeServer() {
...
class HandleASession implements Runnable, _8_TicTacToeConstants {
